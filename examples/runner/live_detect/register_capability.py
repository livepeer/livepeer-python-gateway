"""Register the live-detect capability with the orchestrator.
...
CAPABILITY_NAME = os.environ.get("CAPABILITY_NAME", "live-detect")
CAPABILITY_URL = os.environ.get("CAPABILITY_URL", "http://live_detect:5000")
