"""Register the llm capability with the orchestrator.
...
CAPABILITY_NAME = os.environ.get("CAPABILITY_NAME", "llm")
CAPABILITY_URL = os.environ.get("CAPABILITY_URL", "http://llm:5000")
